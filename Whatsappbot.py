...
app = Flask(__name__)
client = MongoClient('mongodb+srv://John:1234@server.e2xvn.mongodb.net/')
...
# About T John Institute of technology Information
Penta_1 = "T John Institute of technology \nApproved by AICTE, Delhi\n\n" \
                   "To know more about Global Institute Of Management Sciences, Bangalore, visit our website: " \
                   "https://T John Institute of technologyedu.in/"

# Contact Information
contact_info = {
    "Address": "Global Institute Of Management Sciences, Rajarajeshwari Nagar, Bangalore-560098",
    "Phone": "+91 9448963589",
...
def webhook():
    ...
    if sender_phone_number not in user_state:
        ...
        welcome_messages = [
            "*Welcome to our Rohini Institute of technology!!! 💐*",
            "*Hello! 😃*\n *I am from GLAD Association, your guide from Rohini Institute of technology. I can help you with courses, placements, trainings, admissions information, professional development workshops, student welfare, and much more!*",
...
def handle_message(message, phone_number):
    ...
    if message.strip().lower() == "11":
        return "There is an upcoming Rohini Institute of technology Campus drive. Register through this link to get connected: https://docs.google.com/forms/d/1XN9qJlIim66HQKS8-jz8uP9gwuTYA2XZRundgGQ6tco/edit", True
